...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepgymindo.pages.dev/v/${file.filecode}#${file.title}`,
